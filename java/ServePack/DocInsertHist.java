...
/**
 * Servlet implementation class DocInsertHist
 */
@WebServlet("/DocInsertHist")
public class DocInsertHist extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DocInsertHist() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			boolean truth=examining.insertHistory(id_examine, stufftoadd);
			if(truth==true) {
