...
/**
 * Servlet implementation class NurGetSchedServ
 */
@WebServlet("/NurGetSchedServ")
public class NurGetSchedServ extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public NurGetSchedServ() {
        super();
...
//	String =result.getString(3);
		...
		//ut.println(e.getMessage());
			out.println("Error finding Schedule<br> <a href=NurHome.jsp>Home</a>");
		}
